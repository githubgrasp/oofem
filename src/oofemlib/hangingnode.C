...
namespace oofem {
    ...
    std::vector < int > HangingNode::findThreeClosestNodes(FloatArray & hangingNodeCoords, const IntArray &hexaNodes)
    {
        ...
        std::array < double, 3 > hangCoords = {
            hangingNodeCoords.at(1), hangingNodeCoords.at(2), hangingNodeCoords.at(3)
        };
        ...
        for ( size_t i = 0; i < hexaNodes.giveSize(); ++i ) {
            ...
            std::array < double, 3 > masterCoords = {
                masterGlobalCoords.at(1), masterGlobalCoords.at(2), masterGlobalCoords.at(3)
            };
        ...
        return {
                   distances [ 0 ].second, distances [ 1 ].second, distances [ 2 ].second
        };
    }
    ...
    FloatArray HangingNode::computeTriangleRotations(DofIDItem id, FloatArray &hangingNodeCoords, const IntArray &hexaNodes, const FloatArray &translationContribution, Element *e)
    {
        ...
        std::array < double, 3 > X1 = {
            masterGlobalCoords3 [ 0 ] - masterGlobalCoords2 [ 0 ], masterGlobalCoords1 [ 0 ] - masterGlobalCoords3 [ 0 ], masterGlobalCoords2 [ 0 ] - masterGlobalCoords1 [ 0 ]
        };
        std::array < double, 3 > Y1 = {
            masterGlobalCoords3 [ 1 ] - masterGlobalCoords2 [ 1 ], masterGlobalCoords1 [ 1 ] - masterGlobalCoords3 [ 1 ], masterGlobalCoords2 [ 1 ] - masterGlobalCoords1 [ 1 ]
        };
        std::array < double, 3 > Z1 = {
            masterGlobalCoords3 [ 2 ] - masterGlobalCoords2 [ 2 ], masterGlobalCoords1 [ 2 ] - masterGlobalCoords3 [ 2 ], masterGlobalCoords2 [ 2 ] - masterGlobalCoords1 [ 2 ]
        };

        std::array < int, 6 > Array_NodesContr = {
            nodeSurface [ 0 ], nodeSurface [ 1 ], nodeSurface [ 2 ], nodeSurface [ 0 ], nodeSurface [ 1 ], nodeSurface [ 2 ]
        };
