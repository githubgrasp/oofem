...
ConverterTXTDataReader::ConverterTXTDataReader(std::string inputfilename) : ConverterDataReader(),
...
ConverterTXTDataReader::ConverterTXTDataReader(const ConverterTXTDataReader &x) : ConverterTXTDataReader(x.dataSourceName) {}

ConverterTXTDataReader::~ConverterTXTDataReader()
{}

ConverterInputRecord &
...
bool
ConverterTXTDataReader::peakNext(const std::string &keyword)
{
    std::string nextKey;
...
bool
ConverterTXTDataReader::giveLineFromInput(std::ifstream &stream, int &lineNum, std::string &line)
{
...
bool
ConverterTXTDataReader::giveRawLineFromInput(std::ifstream &stream, int &lineNum, std::string &line)
{
    do {
        lineNum++;
