...
#ifndef convertertxtinputrecord_h
#define convertertxtinputrecord_h
 ...
 */
class ConverterTXTInputRecord : public ConverterInputRecord
{
protected:
    /**
...
public:
    ...
    ConverterTXTInputRecord(int linenumber, std::string source);
    /// Copy constructor.
    ConverterTXTInputRecord(const ConverterTXTInputRecord &);
    /// Assignment operator.
    ConverterTXTInputRecord &operator=(const ConverterTXTInputRecord &);

    std::unique_ptr< ConverterInputRecord >clone() const override {
        return std::unique_ptr< ConverterInputRecord >(new ConverterTXTInputRecord(* this) );
    }
...
#endif // convertertxtinputrecord_h
