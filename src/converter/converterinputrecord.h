...
#ifndef converterinputrecord_h
#define converterinputrecord_h
 ...
 */
class ConverterInputRecord
{
public:
    /// Destructor
    virtual ~ConverterInputRecord() = default;

    /** Creates a newly allocated copy of the receiver */
    virtual std::unique_ptr< ConverterInputRecord >clone() const = 0;
...
public:
    ...
    std::string keyword;
    int number;
    InputException(const ConverterInputRecord &ir, std::string keyword, int number);
};
...
public:
    MissingKeywordInputException(const ConverterInputRecord &ir, std::string keyword, int number);
...
public:
    BadFormatInputException(const ConverterInputRecord &ir, std::string keyword, int number);
    const char * what() const noexcept override;
};
...
public:
    ValueInputException(const ConverterInputRecord &ir, std::string keyword, const std::string &reason);
    const char * what() const noexcept override;
};

#endif // converterinputrecord_h
