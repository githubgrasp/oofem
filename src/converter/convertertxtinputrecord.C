...
ConverterTXTInputRecord::ConverterTXTInputRecord() : tokenizer(), record()
{ }

ConverterTXTInputRecord::ConverterTXTInputRecord(const ConverterTXTInputRecord &src) : tokenizer(),
...
ConverterTXTInputRecord::ConverterTXTInputRecord(int linenumber, std::string source) : tokenizer(),
...
ConverterTXTInputRecord &
ConverterTXTInputRecord::operator = ( const ConverterTXTInputRecord &src )
{
...
void ConverterTXTInputRecord::giveRawLine(std::string &dst) const
{
...
void
ConverterTXTInputRecord::setRecordString(std::string newRec)
{
...
void
ConverterTXTInputRecord::giveRecordKeywordField(std::string &answer, int &value)
{
...
void
ConverterTXTInputRecord::giveRecordKeywordField(std::string &keyword, std::string &value)
{
...
void
ConverterTXTInputRecord::giveRecordKeywordField(std::string &answer)
{
    if ( tokenizer.giveNumberOfTokens() > 0 ) {
        answer = std::string(tokenizer.giveToken(1) );
        setReadFlag(1);
...
void
ConverterTXTInputRecord::giveField(int &answer, InputFieldType id)
{
...
void
ConverterTXTInputRecord::giveField(double &answer, InputFieldType id)
{
    int indx = this->giveKeywordIndx(id);
    if ( indx ) {
...
void
ConverterTXTInputRecord::giveField(bool &answer, InputFieldType id)
{
    int indx = this->giveKeywordIndx(id);
    if ( indx ) {
        int val;
...
void
ConverterTXTInputRecord::giveField(std::string &answer, InputFieldType id)
{
    int indx = 0;
    if ( id ) {
...
void
ConverterTXTInputRecord::giveField(oofem::IntArray &answer, InputFieldType id)
{
    int indx = this->giveKeywordIndx(id);
    if ( indx ) {
        int size;
...
void
ConverterTXTInputRecord::giveField(oofem::FloatArray &answer, InputFieldType id)
{
    int indx = this->giveKeywordIndx(id);
    if ( indx ) {
        int size;
...
void
ConverterTXTInputRecord::giveField(oofem::FloatMatrix &answer, InputFieldType id)
{
    int indx = this->giveKeywordIndx(id);
    if ( indx ) {
        int nrows, ncols;
...
void
ConverterTXTInputRecord::giveField(std::vector < std::string > & answer, InputFieldType id)
{
    int indx = this->giveKeywordIndx(id);
    if ( indx ) {
        int size;
...
void
ConverterTXTInputRecord::giveField(oofem::Dictionary &answer, InputFieldType id)
{
    int indx = this->giveKeywordIndx(id);
    if ( indx ) {
        setReadFlag(indx);
...
void
ConverterTXTInputRecord::giveField(std::list < oofem::Range > & list, InputFieldType id)
{
    int indx = this->giveKeywordIndx(id);
    if ( indx ) {
        int li, hi;
...
void
ConverterTXTInputRecord::giveField(oofem::ScalarFunction &answer, InputFieldType id)
{
    const char *rec;
    int indx = this->giveKeywordIndx(id);
...
bool
ConverterTXTInputRecord::hasField(InputFieldType id)
{
...
void
ConverterTXTInputRecord::printYourself()
{
    printf("%s", this->record.c_str() );
}

const char *
ConverterTXTInputRecord::scanInteger(const char *source, int &value)
{
    //
...
const char *
ConverterTXTInputRecord::scanDouble(const char *source, double &value)
{
    //
...
int
ConverterTXTInputRecord::giveKeywordIndx(const char *kwd)
{
...
void
ConverterTXTInputRecord::finish(bool wrn)
{
    if ( !wrn ) {
        return;
    }
...
int
ConverterTXTInputRecord::readRange(const char **helpSource, int &li, int &hi)
{
    char *endptr;
    // skip whitespaces
...
int
ConverterTXTInputRecord::readMatrix(const char *helpSource, int r, int c, oofem::FloatMatrix &ans)
{
