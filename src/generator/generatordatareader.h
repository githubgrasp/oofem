...
#ifndef generatordatareader_h
#define generatordatareader_h
...
public:
     ...
     */
    virtual GeneratorInputRecord &giveInputRecord(GeneratorInputRecordType irType, int recordId) = 0;
