...
/// 2D disk region — the 2D analog of `Sphere`. Reads
/// `#@disk <id> centre 2 cx cy radius r [refine <r>]`. Seeds a solid disc;
/// holes (annulus, multiple voids) are separate `#@holedisk` inclusions.
