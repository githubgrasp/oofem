...
The cross-section is a \texttt{latticecs}, whose \param{shape} parameter selects a facet, circular, rectangular, or property-defined section; it and the section properties are described under Cross section records in the input manual. For a property-defined (frame) section the transverse axes are oriented by \param{zaxis} and the integration point is positioned along the element by \param{s}.
...
\elementDescription{Cross-section}{Defined by a \texttt{latticecs}; see Cross section records in the input manual.}
...
\elementDescription{Cross-section}{As for the \element{lattice3d} element.}
\elementDescription{Unknowns}{Six dofs ($u$-displacement, $v$-displacement, $w$-displacement, $u$-rotation, $v$-rotation and $w$-rotation) are required in each node.}
