...
\begin{figure}[!htb]
\begin{htmlonly}
  \centerline{\includegraphics[width=1.\textwidth]{linkslip.pdf}}
\end{htmlonly}
%begin{latexonly}
...
This is an elastic material model used together with 3d lattice frame elements. It has been specifically developed to describe the failure of steel frame member using the lattice elements latticeframe3d and latticeframe3dnl. However, it can also been used with any other 3d lattice element.
The stress-strain law has the form
\begin{equation}
...
This is a plasticity material used together with 3d lattice frame elements. It has been specifically developed to describe the failure process failure of steel frame member using the lattice elements latticeframe3d and latticeframe3dnl. 
...
\subsubsection{Plasticity-damage lattice model for reinforced concrete}
This is a plasticity-damage material used together with 3d lattice frame elements. It has been specifically developed to describe the failure process failure of reinforced concrete frame member using the lattice elements latticeframe3d and latticeframe3dnl. 
The generalised stress-strain law has the form
\begin{equation}
  \mathbf{s} = \mathbf{D}_{\rm e} \left(\mathbf{e}-\mathbf{e}_{\rm p} \right)
\end{equation}
